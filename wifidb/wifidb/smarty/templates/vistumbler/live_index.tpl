				...
				<div align="center">
					...
					<table border="1" width="100%" cellspacing="0">
						<tbody><tr class="style4">
							...
							<td>
								<a href="?view=1800">30 Minutes</a>
							</td>
							<td>
								<a href="?view=3600">60 Minutes</a>
							</td>
							<td>
								<a href="?view=7200">2 Hours</a>
							</td>
							<td>
								<a href="?view=21600">6 Hours</a>
							</td>
							<td>
								<a href="?view=86400">1 Day</a>
							</td>
							<td>
								<a href="?view=604800">1 Week</a>
							</td>
						</tr>
						</tbody></table>
					<table border="1" width="100%" cellspacing="0">
