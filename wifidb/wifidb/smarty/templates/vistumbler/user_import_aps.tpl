                                ...
                                <table border="1" align="center" width="100%">
                                    <tbody>
                                        ...
                                        <tr class="sub_head">
                                            ...
                                            <td><a class="links" href="{$wifidb_host_url}opt/map.php?func=user_list&row={$wifidb_all_user_row}">Map</a> | <a class="links" href="{$wifidb_host_url}api/geojson.php?func=exp_list&amp;row={$wifidb_all_user_row}&amp;all=1">GeoJSON</a> | <a class="links" href="{$wifidb_host_url}api/export.php?func=exp_list&amp;row={$wifidb_all_user_row}&amp;all=1">KMZ</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br/>
