                        ...
                        <tr>
                            <td>
                                <table border="1" align="center" width="100%">
                                    <tbody>
                                        <tr class="style4">
                                            <th colspan="2">Access Points For: <a class="links" href="{$wifidb_host_url}opt/userstats.php?func=alluserlists&amp;user=aaa">aaa</a></th>
                                        </tr>
                                        <tr class="sub_head">
                                            <td><b>Total Access Points...</b></td><td>4</td>
                                        </tr>
                                        <tr class="sub_head">
                                            <td><b>Export This list To...</b></td><td><a class="links" href="{$wifidb_host_url}opt/export.php?func=exp_user_all_kml&amp;user=aaa">KML</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br/>
                                <table border="1" align="center">
                                    <tbody>
                                        ...
                                        {foreach name=outer item=wifidb_users_aps from=$wifidb_users_aps_all}
                                        <tr class="{$wifidb_users_aps.class}">
                                            <td align="center">{$wifidb_users_aps.id}</td>
                                            <td align="center">{$wifidb_users_aps.row}</td>
