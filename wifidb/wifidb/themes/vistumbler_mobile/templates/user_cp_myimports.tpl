...
{include file="user_cp_header.tpl"}
				<div class="center">
					...
					<table class="content_table">
						<tbody>
							<tr class="subheading">
								<th class="subheading" colspan="10">Imported Files</th>
							</tr>
							<tr class="header">
							...
							<tr class="{$wifidb_user_prev.class}">
								...
								<td class="{$wifidb_user_prev.class}">
									<a href="{$wifidb_host_url}cp/user_action.php?action=delete_my_file&amp;file_id={$wifidb_user_prev.id}&amp;return={$wifidb_host_url}cp/index.php?func=myimports" title="Delete this import (permanent)" style="font-size: 16px; color: #cc0000;">&#x1F5D1;</a>
								</td>
							</tr>
							{foreachelse}
							<tr class="light">
								<td class="light" colspan="10">You have no imports yet.</td>
							</tr>
							{/foreach}
						</tbody>
					</table>
