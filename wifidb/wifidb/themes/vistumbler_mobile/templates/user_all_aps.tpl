...
{foreach name=outer item=wifidb_users_aps from=$wifidb_all_user_aps.allaps}
							<tr class="{$wifidb_users_aps.class}">
								...
								{if $wifidb_users_aps.validgps eq 1}
									...
									<a href="{$wifidb_host_url}opt/map.php?func=exp_ap_sig&labeled=0&id={$wifidb_users_aps.id}&from=0&inc=50000" title="Show Signals on Map"><img width="20px" src="{$themeurl}img/sigmap_on.png"></a>
									<a href="{$wifidb_host_url}api/geojson.php?json=1&func=exp_ap&id={$wifidb_users_aps.id}&from=0&inc=50000" title="Export to JSON"><img width="20px" src="{$themeurl}img/json_on.png"></a>
