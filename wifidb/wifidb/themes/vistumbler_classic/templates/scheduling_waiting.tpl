...
{include file="header.tpl"}
			<div class="main">
				...
				{literal}
				<script>document.addEventListener('DOMContentLoaded', function(){ if(typeof schedulingLiveInit === 'function'){ schedulingLiveInit({func:'waiting', interval:15000}); }});</script>
				{/literal}
				<div class="center">
