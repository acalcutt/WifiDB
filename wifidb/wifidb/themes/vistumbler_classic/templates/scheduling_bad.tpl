	...
	<style>
	/* Make scheduling tables responsive and wrap long text; use auto layout like done page */
				...
				<div class="center">
					...
					<table class="content_table">
						...
						<tr class="badrow">
							...
							<td class="{$badfile.class} titlecol">{$badfile.title|escape:'htmlall'}</td>
							<td class="{$badfile.class} typecol">{$badfile.type|escape:'htmlall'}</td>
							<td class="{$badfile.class} filecol">{if $badfile.file_name}{$badfile.file_name|escape:'htmlall'}{else}{$badfile.file|escape:'htmlall'}{/if}</td>
							<td class="{$badfile.class} notescol">{$badfile.notes|escape:'htmlall'}</td>
							<td class="{$badfile.class} hashcol" colspan="2">{$badfile.hash|escape:'htmlall'}</td>
						</tr>
						<tr class="header-centered">
							<th class="header"></th>
							<th width="95px" class="header">Error</th>
							<th class="header">&nbsp;</th>
						...
						<tr class="badrow">
							<td class="header"></td>
							<td class="{$badfile.class}">{$badfile.error|escape:'htmlall'}</td>
							<td class="{$badfile.class}"></td>
							<td class="{$badfile.class}">{$badfile.date|escape:'htmlall'}</td>
							<td class="{$badfile.class}">{$badfile.size|escape:'htmlall'}</td>
							<td class="{$badfile.class}">{$badfile.user|escape:'htmlall'}</td>
							<td class="{$badfile.class}"></td>
							<td class="{$badfile.class}"></td>
						</tr>
						{if not $smarty.foreach.bad.last}
						<tr class="content-centered"><th colspan="6"><br/></th></tr>
						{/if}
						{foreachelse}
