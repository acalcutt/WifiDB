...
{include file="header.tpl"}
									...
									<a class="links" href="https://www.vistumbler.net" target="_blank">Vistumbler VS1/VSZ/CSV/MDB</a>
									files are the main import formats.<br/>
									For Android, we support 
									<a class="links" href="https://github.com/raffaeleragni/android-wardrive4/releases" target="_blank">Wardrive DB/DB3</a>,
									<a class="links" href="https://play.google.com/store/apps/details?id=net.wigle.wigleandroid" target="_blank">WiggleWifi CSV</a>, and
									<a class="links" href="https://play.google.com/store/apps/details?id=com.Buckynet.Wifi.Scanner.Wireless.SWardriving&hl=en_US" target="_blank">SWardriving CSV</a><br><br> 
